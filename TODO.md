...
- [x] REG-002 Implement immutable content-addressed agent versions with image digest, model/tool/skill/subagent declarations, limits, and schema validation. — completed 2026-08-22, commit `pending`, evidence: canonical manifest/digest/schema and application unit/race tests; migration 006 checksum/schema tests; PostgreSQL 18.4 atomic registration, tenant isolation, long skill bound, duplicate digest, and direct mutation rejection integration; OpenAPI lint; `make verify`
