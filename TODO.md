...
- [x] DATA-012 Evaluate PostgreSQL row-level security as defense in depth; implement it or record why repository enforcement is used for RC. — completed 2026-08-19, commit `pending`, evidence: ADR-0002 threat/role/pooling evaluation; tenant repository unit/race tests; PostgreSQL 18.4 cross-tenant isolation test; `make verify`
