...
| 2026-08-10 | ENG-007 | `PENDING` | request/trace correlation, recovery/redaction, limits, RFC 7807, metrics, probe, readiness lifecycle, listener shutdown, OpenAPI, and process smoke evidence; full race/vet/build/source/license/vulnerability gates | Initial readiness is process-local; PostgreSQL, policy, and revocation freshness gates remain in their owning phases |
