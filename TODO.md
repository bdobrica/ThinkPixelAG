...
- [x] DATA-010 Implement transactional audit/outbox writes and a replay-safe publisher with bounded retry, jitter, leases/claims, and poison-message handling. — completed 2026-08-19, commit `pending`, evidence: atomic mutation/audit/outbox rollback and commit; PostgreSQL 18.4 concurrent claim, retry, dead-letter, and race tests; `make verify`
