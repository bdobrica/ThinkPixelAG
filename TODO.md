...
- [x] DATA-007 Implement connection pool configuration, dependency health, transaction helpers, error classification, statement timeouts, and telemetry. — completed 2026-08-19, commit `PENDING`, evidence: configuration/adapter/telemetry unit and race tests; PostgreSQL 18.4 session-timeout and readiness integration test; `make verify`
