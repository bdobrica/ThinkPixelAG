...
- [x] REG-007 Commit Phase 3 with API/policy documentation and verification evidence. — completed 2026-08-22, commit `PENDING`, evidence: `docs/phase-3-evidence.md`; API/policy documentation reconciliation; clean-tree `make verify`
