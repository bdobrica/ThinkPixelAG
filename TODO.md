...
- [x] REG-001 Implement agent creation/update semantics, owner/sponsor/risk validation, and tenant-scoped list/describe repositories/use cases. — completed 2026-08-20, commit `pending`, evidence: agent aggregate/application/PostgreSQL unit and race tests; PostgreSQL 18.4 tenant isolation, principal eligibility, list/describe, and optimistic update integration; OpenAPI lint; `make verify`
