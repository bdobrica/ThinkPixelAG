...
- [x] REG-005 Implement public agent list/describe endpoints with cursor pagination, authorization filtering, and enumeration-safe errors. — completed 2026-08-22, commit `PENDING`, evidence: application/HTTP authorization and cursor unit/race tests; OpenAPI lint; `make verify`
