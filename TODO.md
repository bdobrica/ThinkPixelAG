...
- [x] REG-004 Implement policy-driven version resolution, optional controlled rollback/test pinning, and persisted resolution snapshots. — completed 2026-08-22, commit pending, evidence: resolver/domain unit and race tests; pinned OPA 1.19.0 19-case policy suite; migration 008 checksum/schema tests; PostgreSQL 18.4 eligibility, tenant isolation, stale-revocation rejection, immutable snapshot, and migration integration tests; OpenAPI lint; `make verify`
