...
- [x] DATA-009 Implement request-hash-bound idempotency acquisition, replay, conflict, expiry, and concurrent-request behavior. — completed 2026-08-19, commit `PENDING`, evidence: deterministic hash/validation/outcome unit tests; PostgreSQL 18.4 concurrent single-owner, replay, hash-conflict, TTL replacement, lease takeover, and stale-owner fencing integration/race tests; `make verify`
