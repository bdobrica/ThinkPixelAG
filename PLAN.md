...
Status: **In progress.** ENG-001 through ENG-009 are implemented; CI and the
baseline image remain. Local development uses immutable image-index pins for
...
only authoritative PostgreSQL state by default. Valkey remains disposable.
