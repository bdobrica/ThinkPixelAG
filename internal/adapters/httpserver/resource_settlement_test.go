...
func TestResourceSettlementBindsAuthenticatedActor(t *testing.T) {
	...
	handler, _ := ResourceSettlementHandler(&fakeVerifier{principal: oidc.Principal{ID: actor.String(), TenantID: tenant.String(), Roles: []string{"trusted-workload"}}}, service, ResourceSettlementHTTPConfig{})
