...
allow_result := allow("workload.operation.allowed", 0) if { tenant_ok; input.security_state.authoritative; input.action == "resources.settle"; has_role("trusted-workload") }
