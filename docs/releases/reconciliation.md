...
| Item | Disposition |
|---|---|
| Production performance / composed worker and gateway / HA | DQ-001–004 in the [deferral register](../operations/deferred-qualification.md); accepted for this integration RC, never marked passed |
