# Integration-RC operating envelope (RC-003)
...
targets](../operations/slos.md) remain unchanged. Their remaining qualification
is explicitly [deferred](../operations/deferred-qualification.md), not passed.
...
Sources: [durable evidence qualification](../operations/ssd-evidence-qualification.md),
[read/admission comparisons](../operations/ssd-qualification.md), and their linked
...
see [lifecycle evidence](../operations/ops012-evidence.md). Preserve readiness,
...
[runbooks](../operations/runbooks.md) for dependency failures and invariant
