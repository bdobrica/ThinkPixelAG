...
recorded in [final RC qualification](../rc/final-artifacts.md). This report
...
The [deferred qualification register](../../adr/0012-integration-rc-qualification-deferrals.md) preserves
...
| Area | Evidence |
|---|---|
| Images, deployment, isolation, probes, metrics, alerts and runbooks | [Phase 8 foundation](../implementation/phase-8-evidence.md), OPS-001–008 |
| PostgreSQL backup, WAL/PITR, forward schema and invariant checks | [Recovery qualification](../../operations/testing/recovery-testing.md), OPS-009 |
