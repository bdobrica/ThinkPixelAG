...
[qualification deferrals](../../adr/0012-integration-rc-qualification-deferrals.md). Historical results and
...
| --- | --- | --- |
| OCI, manifests, hardening, runbooks and release automation | OPS-001–004, OPS-008, OPS-013; historical multiarch image, scan, install/uninstall and release contract checks | `967165a`, [Phase 8 evidence](../implementation/phase-8-evidence.md) |
| Readiness, telemetry, alerts | OPS-005–007; freshness-bound readiness, live collectors and 27 validated alert rules | `e528009`, `01135d6`, `41ab200`, `bd203e5`, [Phase 8 evidence](../implementation/phase-8-evidence.md) |
| Backup and PITR | OPS-009; encrypted physical backup/WAL recovery, authoritative invariants and forward migration | `fa04a0c`, [recovery procedure](../../operations/testing/recovery-testing.md) |
...
replace current failures. Production targets remain in [SLOs](../../operations/slos.md).
