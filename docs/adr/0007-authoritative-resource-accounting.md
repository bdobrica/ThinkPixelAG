...
- [Resource contract](../contracts/resource-accounting.md), [Phase 5 evidence](../phase-5-evidence.md)
- [Deployed Valkey drill](../operations/phase-8-closeout.md)
- [Historical plan](../releases/history/PLAN.md), section 3.6; RES-001–014 in the [ledger](../releases/history/TODO.md)
